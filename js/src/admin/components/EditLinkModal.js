...
export default class EditlinksModal extends Modal {
  ...
  title() {
    ...
    if (!title) {
      return app.translator.trans('flarum-ui-links.admin.edit_link.title');
    }
  ...
  items() {
    ...
    items.add(
      ...
      [
        <div className="Form-group">
          <label>{app.translator.trans('flarum-ui-links.admin.edit_link.title_label')}</label>
          <input className="FormControl" placeholder={app.translator.trans('flarum-ui-links.admin.edit_link.title_placeholder')} bidi={this.itemTitle} />
        </div>,
      ],
      100
    );
    ...
    items.add(
      ...
      [
        <div className="Form-group">
          <label>{app.translator.trans('flarum-ui-links.admin.edit_link.icon_label')}</label>
          <div className="helpText">
            {app.translator.trans('flarum-ui-links.admin.edit_link.icon_text', {
              a: <a href="https://fontawesome.com/v5/search?o=r&m=free" tabindex="-1" />,
            })}
            <br />
            {app.translator.trans('flarum-ui-links.admin.edit_link.icon_additional_text')}
          </div>
    ...
    items.add(
      ...
      [
        <div className="Form-group">
          <label for="link-url">{app.translator.trans('flarum-ui-links.admin.edit_link.url_label')}</label>
          <p class="helpText" id="link-url-help">
            {app.translator.trans('flarum-ui-links.admin.edit_link.url_description')}
          </p>
          <div id="link-url-input" data-internal={this.isInternal()}>
            ...
            <input
              ...
              placeholder={app.translator.trans('flarum-ui-links.admin.edit_link.url_placeholder')}
              type="text"
        ...
        <div className="Form-group">
          <div>
            <label className="checkbox">
              ...
              />
              {app.translator.trans('flarum-ui-links.admin.edit_link.internal_link')}
            </label>
            <label className="checkbox">
              <input
                type="checkbox"
              ...
              />
              {app.translator.trans('flarum-ui-links.admin.edit_link.open_newtab')}
            </label>
            <label className="checkbox">
              <input type="checkbox" value="1" bidi={this.useRelMe} />
              {app.translator.trans('flarum-ui-links.admin.edit_link.use_rel_me')}
            </label>
          </div>
        </div>,
      ],
    ...
    items.add(
      ...
      [
        <div className="Form-group">
          <label>{app.translator.trans('flarum-ui-links.admin.edit_link.visibility')}</label>
          {Select.component({
      ...
      [
        <div className="Form-group">
          {Button.component(
            ...
            app.translator.trans('flarum-ui-links.admin.edit_link.submit_button')
          )}
          {this.link.exists ? (
            <button type="button" className="Button Button--danger EditLinkModal-delete" onclick={() => this.delete()}>
              {app.translator.trans('flarum-ui-links.admin.edit_link.delete_link_button')}
            </button>
          ) : (
            ''
          )}
  ...
  typeOptions() {
    let opts;
    opts = ['everyone', 'members', 'mods'].reduce((o, key) => {
      o[key] = app.translator.trans(`flarum-ui-links.admin.edit_link.${key}-label`);
  ...
  delete() {
    if (confirm(app.translator.trans('flarum-ui-links.admin.edit_link.delete_link_confirmation'))) {
