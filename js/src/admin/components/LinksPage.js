  ...
  return (
    <li data-id={link.id()}>
      <div className="LinkListItem-info">
        <span className="LinkListItem-name">
          {link.icon() ? icon(link.icon()) : ''} {link.title()}
        </span>
        <span className="LinkListItem-visibility">{link.visibility()}</span>
        {Button.component({
      ...
      <div className="LinksPage">
        <div className="ExtensionPage-permissions-header">
          <div className="container">
            <h2 className="ExtensionTitle">{app.translator.trans('flarum-ui-links.admin.links.links')}</h2>
          </div>
        </div>
        <div className="container">
          {Button.component(
            ...
            app.translator.trans('flarum-ui-links.admin.links.create_button')
          )}
        </div>
